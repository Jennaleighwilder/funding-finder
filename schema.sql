...
-- Sample funding sources (real examples)
...
INSERT INTO funding_sources (
    ...
    success_rate, quality_score, legitimacy_verified
) VALUES 
(
    ...
    10000, 500000, 75000,
    '2026-06-30', 'annual',
    'ALL', '["business", "nonprofit"]', '["agriculture", "food", "manufacturing"]',
    'Must be in rural area (population < 50,000). Must create or save jobs. Must benefit rural community.',
...
(
    ...
    NULL, 'monthly',
    'ALL', '["business"]', 'ALL',
    'Must be woman-owned business. Must be for-profit or nonprofit. No restrictions on industry.',
    'https://www.womensnet.org/ambergrant',
    'simple',
    0.08, 90, 1
),
(
    ...
    '2026-05-15', 'annual',
    'ALL', '["business"]', 'ALL',
    'Must be small business (under 99 employees). Must demonstrate community impact.',
    'https://smallbusinessgrant.fedex.com/',
    'moderate',
    0.05, 88, 1
);
